...
import { InterviewStatus, InterviewType, UserType } from "./enums.ts";
...
export const interviewMockData: InterviewScheduleDetailsResponse = {
  id: 1,
  title: "Technical Interview",
  description: "In-depth final interview.",
  date: "2025-06-01",
  startTime: "10:00",
  endTime: "11:00",
  timeZone: "Africa/Lagos",
  duration: 60,
  interviewType: InterviewType.VIRTUAL_MEETING,
  interviewPlatform: "Zoom",
  interviewLink: "https://zoom.us/j/1234567890?pwd=abcdEFGH1234",
  status: InterviewStatus.SCHEDULED,
  interviewState: "Kaduna",
  interviewCity: "Kaduna North",
  interviewAddress: "No. 123 Isa Kaita Road",
  interviewerPhoneNumber1: "+2348012345678",
  interviewerPhoneNumber2: "+2348098765432",
  interviewerEmail1: "hr@company.com",
  files: ["cv.pdf", "portfolio.pdf"],
  notes: "Candidate prefers to work remotely.",
  applicants: [
    {
      id: 101,
      firstName: "A.S",
      ...
      githubProfile: null,
      governmentIdentificationNumber: null,
  ...
  job: {
    ...
    applicationMethod: "byCv" as ApplicationMethod,
    employer: {} as any,
    applicantsCount: 5,
    minAmount: 5000,
    maxAmount: 7000,
