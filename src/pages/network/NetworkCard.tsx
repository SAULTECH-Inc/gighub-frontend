          ...
          <div className="flex justify-center py-4">
            <div className="flex space-x-1 rounded-lg bg-gray-100 p-1">
              <button
                ...
                className={`flex items-center space-x-2 rounded-md px-6 py-3 text-sm font-medium transition-all duration-200 ${activeTab === "find-new-connections"
              ...
              <button
                ...
                className={`flex items-center space-x-2 rounded-md px-6 py-3 text-sm font-medium transition-all duration-200 ${activeTab === "my-connections"
                    ? "bg-white text-purple-600 shadow-sm"
                    : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                  }`}
              >
