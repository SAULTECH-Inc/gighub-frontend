...
const LoginPage = () => {
  ...
  const handleSocialLogin =
    (provider: string, loginHandler: () => Promise<void> | void) =>
    async () => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="text-center">
          <Loader2 className="mx-auto mb-4 h-8 w-8 animate-spin text-[#6438C2]" />
  ...
  return (
    ...
    >
      {/* Header for mobile */}
      <motion.div
        className="bg-white p-4 shadow-sm lg:hidden"
      ...
      <motion.h1
        className="absolute top-8 left-8 z-10 hidden text-2xl font-bold text-[#674EE5EE] lg:block xl:text-3xl"
      ...
      <div className="flex flex-1 items-center justify-center p-4 lg:p-8">
        ...
        >
          {/* Logo for desktop */}
          <motion.div
            className="mb-8 hidden items-center justify-center gap-2 lg:flex"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            {socialProviders.map((provider) => (
              <motion.button
                ...
                className={`relative border-none transition-all duration-200 hover:bg-transparent ${provider.color} disabled:cursor-not-allowed disabled:opacity-50`}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/forgot-password"
                className="text-sm text-[#6438C2] transition-colors hover:text-[#542F9E] focus:underline focus:outline-none"
              >
                Forgot Password?
              </Link>
            </div>
            ...
            <motion.button
              ...
              className={`w-full rounded-lg px-4 py-3 font-medium text-white transition-all duration-200 ${
                isLoading
                  ...
                  : "bg-[#6438C2] hover:bg-[#542F9E] active:scale-[0.98] active:transform"
          ...
          >
            ...
            <Link
              ...
              className="font-semibold text-[#6438C2] transition-colors hover:text-[#542F9E] focus:underline focus:outline-none"
            >
              Sign up
            </Link>
          </motion.p>
      ...
      <motion.div
        className="hidden items-center justify-center p-4 lg:flex lg:w-1/2 xl:w-2/5"
