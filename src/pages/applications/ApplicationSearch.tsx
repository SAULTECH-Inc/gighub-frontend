...
const statuses = [
  ...
  { label: "Shortlisted", value: "Shortlisted", color: "bg-blue-100 text-blue-700" },
];
...
const ApplicationSearch: React.FC<ApplicationSearchProps> = memo(({
  ...
  const handleSortChange = useCallback((orderBy: string) => {
    setSort(prev => ({
      ...prev,
      orderBy,
      sortDirection: prev.orderBy === orderBy && prev.sortDirection === 'asc' ? 'desc' : 'asc'
    }));
    setSortOpen(false);
  }, [setSort]);
  ...
  const selectedSortData = sortOptions.find(s => s.value === sort.orderBy) || sortOptions[0];
        ...
        <div className="hidden xl:block">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <span className="text-sm font-medium text-slate-700 min-w-fit">Filter by status:</span>
            ...
            {/* Sort Options Row */}
            <div className="flex items-center space-x-3">
              <span className="text-sm font-medium text-slate-700 min-w-fit">Sort by:</span>
              <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="flex items-center justify-end space-x-3 lg:hidden">
          ...
          <div className="relative">
            <motion.button
              ...
              className="flex items-center space-x-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition-all hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
