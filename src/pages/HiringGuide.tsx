...
const STEPS = [
  ...
  },
  {
    ...
    description: 'Message shortlisted candidates directly through GigHub. Keep all communications organized in one place.',
    ...
    <>
      ...
      <div className="p-6 max-w-4xl mx-auto space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="text-2xl font-bold text-foreground">The GigHub Hiring Guide</h1>
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 text-center space-y-3">
          ...
          <p className="text-xs text-muted-foreground">Join thousands of employers who found their next great hire on GigHub.</p>
