...
const SavedJob = () => {
  ...
  const actualSavedJobData = applicantSettings?.notifications?.options?.savedJob;
  ...
  useEffect(() => {
    ...
    if (savedJobData && (!actualSavedJobData ||
  ...
  const handleNotificationTypeToggle = useCallback((key: string) => {
    ...
    const updatedSettings = {
      ...
      notificationType: {
        ...
        [key]: !actualSavedJobData.notificationType[key as keyof NotificationType],
      },
    };
    setSavedJob(updatedSettings);
    debouncedUpdate(updatedSettings);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {savedJobOptions.map((option) => {
                ...
                const isActive = actualSavedJobData?.option?.[option.key as keyof SavedJobStates] || false;
            ...
            <div className="space-y-4">
              {notificationTypeOptions.map((option) => {
                const IconComponent = option.icon;
                const isActive = actualSavedJobData?.notificationType?.[option.key as keyof NotificationType] || false;
