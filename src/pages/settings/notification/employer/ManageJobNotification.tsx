...
const ManageJobNotification = () => {
  ...
  const actualManageJobApplicationsData =
  ...
  useEffect(() => {
    const manageJobApplicationsData =
      employerSettings?.notifications?.options?.manageJobApplications;

    if (
      manageJobApplicationsData &&
      (!actualManageJobApplicationsData ||
        JSON.stringify(actualManageJobApplicationsData) !==
          JSON.stringify(manageJobApplicationsData))
    ) {
  ...
  const handleManageJobToggle = useCallback(
    (key: string) => {
      ...
      const updatedSettings = {
        ...
        option: {
          ...
          [key]:
            !actualManageJobApplicationsData.option[
              key as keyof ManageJobNotificationState
            ],
        },
      };
    ...
    <section className="font-lato flex w-[95%] flex-col self-center py-10 md:w-[90%]">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">
          Stay informed about candidate applications and manage your hiring
          process efficiently.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              {manageJobOptions.map((option) => {
                ...
                const isActive =
                  actualManageJobApplicationsData?.option?.[
                    option.key as keyof ManageJobNotificationState
                  ] || false;
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex flex-1 items-start space-x-3">
                        <div
                          className={`rounded-lg p-2 transition-colors duration-200 ${isActive ? "bg-cyan-100 text-cyan-600" : "bg-gray-100 text-gray-500"} `}
                        >
