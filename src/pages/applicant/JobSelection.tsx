  ...
  return (
    <div className="w-full flex justify-center min-h-screen bg-[#F7F7F7]">
      <div className="w-[96%] sm:w-[90%] flex flex-col gap-5">
        <div className="w-[96%]sm:w-[90%] flex justify-between sm:bg-white rounded-[16px] sm:py-4 py-2 sm:px-4 px-2 gap-1 sm:gap-4">
          <div className="border border-[#E6E6E6] bg-white sm:bg-[#F7F7F7] rounded-[10px] py-3 px-4 md:min-w-[381px]">
            <input
              type="text"
          ...
          <div>
            <div className="border border-[#E6E6E6] bg-[#FFFFFF] py-3 min-w-[59px] px-4 rounded-[10px] flex sm:hidden justify-center items-center">
        ...
        <div className="w-[96%] sm:w-[100%] self-center">
          {activeSection === "open" && (
            <div className=" bg-white px-4 pt-4 pb-[100px] rounded-[10px] flex flex-wrap justify-center gap-3">
              <div className="hidden bg-[#6438C2] text-white w-full p-2 px-4 rounded-[10px] lg:flex justify-between">
