...
interface ApplicantJobProfile {
  ...
  updateSocials: (
    socials: SocialsResponseDto[],
  ) => Promise<SocialsResponseDto[]>;
  addExperience: (
    experience: ExperienceRequestDto,
  ) => Promise<ExperienceResponseDto | null>;
  updateExperience: (
    experience: ExperienceResponseDto,
  ) => Promise<ExperienceResponseDto | null>;
  updateSkillsAndCompetencies: (
    skillsAndCompetency: SkillsAndCompetency,
  ) => Promise<SkillsAndCompetency>;
  ...
  ) => Promise<EducationResponseDto | null>;
  ...
  error: string | null;
  loading: boolean;
  fetchPreferences: () => Promise<JobPreferenceResponse | null>;
  ...
  ) => Promise<JobPreferenceResponse | null>;
    ...
    persist(
      immer<ApplicantJobProfile>((set) => ({
        ...
        fetchPreferences: async () => {
          ...
          try {
            const response =
              await privateApiClient.get<APIResponse<JobPreferenceResponse>>(
                `/jobs/get-preference`,
              );
            set((state) => {
        ...
        updatePreference: async (preference: JobPreference) => {
          ...
          try {
            const response = await privateApiClient.post<
              APIResponse<JobPreferenceResponse>
            >(`/jobs/add-preference`, preference);
            set((state) => {
        ...
        fetchCvDetails: async () => {
          ...
          try {
            const response =
              await privateApiClient.get<APIResponse<CvResponseDto>>(
                `/cv/get-details`,
              );
            set((state) => {
        ...
        updatedApplicantEducation: async (data: EducationResponseDto) => {
          try {
            ...
            const response = await privateApiClient.put<
              APIResponse<EducationResponseDto>
            >(`${API_BASE_URL}/cv/update-education`, data);
            set((state) => {
              state.loading = false;
              state.error = null;
            });
            ...
            set((state) => {
              state.error =
                ...
                "Error updating education information";
              state.loading = false;
            });
            handleError(error);
            return null;
        ...
        deleteEducation: async (educationId: number) => {
          try {
            const response = await privateApiClient.delete<APIResponse<void>>(
              `/cv/delete-education/${Number(educationId)}`,
            );
        ...
        fetchApplicantEducation: async () => {
          try {
            ...
            const response =
              await privateApiClient.get<APIResponse<EducationResponseDto[]>>(
                `/cv/get-educations`,
              );
            set((state) => {
        ...
        addApplicantEducation: async (data) => {
          try {
            ...
            const response = await privateApiClient.post<
              APIResponse<EducationResponseDto>
            >(`${API_BASE_URL}/cv/add-education`, data);
            set((state) => {
              state.loading = false;
              state.error = null;
            });
        ...
        fetchExperiences: async () => {
          try {
            ...
            const response =
              await privateApiClient.get<APIResponse<ExperienceResponseDto[]>>(
                `/cv/get-experiences`,
              );
            set((state) => {
        ...
        addExperience: async (data) => {
          try {
            ...
            const response = await privateApiClient.post<
              APIResponse<ExperienceResponseDto>
            >(`${API_BASE_URL}/cv/add-experience`, data);
            set((state) => {
              state.loading = false;
              state.error = null;
            });
            ...
            set((state) => {
              state.error =
                err.response?.data?.message ||
                "Error updating experience information";
              state.loading = false;
            });
            handleError(err);
            return null;
        ...
        updateExperience: async (data) => {
          try {
            ...
            const response = await privateApiClient.put<
              APIResponse<ExperienceResponseDto>
            >(`${API_BASE_URL}/cv/experiences/${data.id}/update`, data);
            set((state) => {
              state.loading = false;
              state.error = null;
            });
        ...
        deleteExperience: async (experienceId: number) => {
          try {
            const response = await privateApiClient.delete<APIResponse<void>>(
              `${API_BASE_URL}/cv/experiences/${Number(experienceId)}`,
            );
        ...
        updateSkillsAndCompetencies: async (
          skillAndCompetences: SkillsAndCompetency,
        ) => {
          try {
            set((state) => {
              state.loading = true;
            ...
            const response = await privateApiClient.put<
              APIResponse<SkillsAndCompetency>
            >(
              `${API_BASE_URL}/cv/skills-and-competencies`,
              skillAndCompetences,
            );
            set((state) => {
              state.loading = false;
            ...
            set((state) => {
              state.error =
                err.response?.data?.message ||
                "Error updating skills and competencies";
              state.loading = false;
            });
            handleError(err);
        ...
        uploadProfileFile: async (data: FileUploadRequest) => {
          try {
            ...
            if (typeof data.file === "string") {
              console.error(
                "File must be of type File, but received a string.",
              );
            ...
            >(`${VITE_API_FILE_SERVICE}/gighub/upload`, formData, {
              headers: {
            ...
            set((state) => {
              state.error =
                err.response?.data?.message || "Error uploading profile file";
              state.loading = false;
            });
            handleError(err);
        ...
        deleteProfileFile: async (data: FileUploadRequest) => {
          try {
            ...
            const response = await privateApiClient.post<APIResponse<boolean>>(
              `${VITE_API_FILE_SERVICE}/gighub/files/delete`,
              data,
            );
            set((state) => {
              state.loading = false;
            ...
            set((state) => {
              state.error =
                err.response?.data?.message || "Error deleting profile file";
              state.loading = false;
            });
            handleError(err);
            return false;
        ...
        updatePortfolioLinks: async (links: string[]) => {
          try {
            ...
            const response = await privateApiClient.put<APIResponse<string[]>>(
              `${API_BASE_URL}/cv/portfolio-links`,
              links,
            );
            set((state) => {
              state.loading = false;
            ...
            set((state) => {
              state.error =
                err.response?.data?.message || "Error updating portfolio links";
              state.loading = false;
            });
            handleError(err);
            return [];
        ...
        updateSocials: async (socials: SocialsResponseDto[]) => {
          try {
            ...
            const response = await privateApiClient.put<
              APIResponse<SocialsResponseDto[]>
            >(`${API_BASE_URL}/cv/socials`, socials);
            set((state) => {
              state.loading = false;
              state.error = null;
            });
            ...
            set((state) => {
              state.error =
                err.response?.data?.message || "Error updating socials";
              state.loading = false;
            });
            handleError(err);
            return [];
