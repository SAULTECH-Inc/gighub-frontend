...
const MainFooter: React.FC = () => {
    ...
    return (
        <footer
            className="relative mt-0 overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white md:mt-10">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6 py-12">
                ...
                <div className="mb-12 grid grid-cols-1 gap-8 border-b border-gray-700 pb-12 lg:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            {
                                !isSubscribed && (<div className="flex flex-col gap-3 sm:flex-row">
                                    <input
                                        type="email"
                                        value={email}
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div
                            className="rounded-lg border border-gray-700 bg-gray-800/50 p-4 text-center transition-all duration-300 hover:bg-gray-800/70">
                ...
                {/* Contact Information */}
                <div
                    className="mb-12 grid grid-cols-1 gap-6 border-b border-gray-700 pb-8 md:grid-cols-2 lg:grid-cols-4">
                    <div
                        className="flex items-center gap-3 rounded-lg bg-gray-800/30 p-4 transition-all duration-300 hover:bg-gray-800/50">
                ...
                <div className="mb-8 flex flex-col items-center justify-between gap-8 lg:flex-row">
                    ...
                    <div className="flex flex-col items-center lg:items-end">
                        ...
                        <div className="flex gap-4">
                            ...
                            >
                                <div
                                    className="flex h-12 w-36 items-center justify-center rounded-lg border border-gray-600 bg-black text-xs text-white">
                ...
                <div
                    className="mb-8 flex flex-wrap items-center justify-center gap-6 border-t border-b border-gray-700 py-6">
                    <div
