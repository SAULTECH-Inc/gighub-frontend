...
const ApplicantSignupStepOne: React.FC<StepOneProp> = ({ handleNext }) => {
  ...
  return (
    <motion.div
      className="mt-5 w-[100%-2rem] px-[10px] md:mr-28 md:mt-32 md:w-[680px] lg:w-[500px] lg:px-0"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      ...
      >
        <div className="flex flex-1 flex-col">
          ...
          <input
            ...
            className="mb-4 h-[45px] w-full rounded-[16px] border-[1px] border-[#E6E6E6] px-5 py-2 focus:border-[1px] focus:border-[#E6E6E6] focus:outline-none focus:ring-0"
          />
        </div>
        <div className="flex flex-1 flex-col">
          <label className="mb-2 block text-[13px] font-medium text-[#000000]">
      ...
      <motion.div
        className="mx-auto mb-4 mt-8 flex items-center justify-evenly gap-x-2"
        initial={{ y: 50 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.5 }}
      >
