    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="flex flex-col flex-1">
                    <label className="block text-[#000000] text-[13px] font-medium mb-2">Surname</label>
                    <input
                        type="text"
                        name="surname"
            ...
            <motion.div
                ...
                transition={{ duration: 0.5 }}
            >
                <div className="p-2 flex justify-evenly items-center cursor-pointer border-[1px] border-[#E6E6E6] rounded-[16px] w-[97px] h-[44px]">
            ...
            >
                <p className="text-center text-[16px] text-[#AFAFAF]">
                    Signing Up for GigHub means you agree to the <span className="text-[#674EE5EE]">Privacy Policy</span> and <span className="text-[#674EE5EE]">Terms</span> of <span className="text-[#674EE5EE]">Services</span>
                </p>
            </motion.div>
        </motion.div>
    );
