...
const PublicProfileCard: React.FC<PublicProfileCardProp> = ({ user }) => {
  ...
  return (
    <div className="mdl:h-[118px] h-[150px] w-full items-center justify-between rounded-t-[16px] bg-[#6B5AED] p-4 text-white">
      <section className="mdl:flex-row mt-10 flex h-fit w-full flex-col items-center gap-y-6 bg-white p-6 shadow md:justify-between">
        ...
        <div className="flex w-full gap-x-4 gap-y-3">
          <button className="w-[150px] rounded-[10px] bg-[#F7F7F7] px-6 py-2 text-sm text-black transition duration-200">
            Follow us
          </button>
          <button
            onClick={() => {
            ...
            className="w-[200px] rounded-lg bg-[#6438C2] px-6 py-2 text-sm text-white transition duration-200 hover:bg-purple-700"
          >
            Send Message
          </button>
        </div>
