        ...
        <div className="px-6 py-8 sm:px-8">
          <div className="flex flex-col items-center space-y-6 sm:flex-row sm:space-y-0 sm:space-x-8">
            ...
            <div className="relative shrink-0">
              ...
              {/* Verification Badge */}
              <div className="absolute -right-2 -bottom-2 rounded-full bg-green-500 p-1.5 shadow-md">
            ...
            <div className="min-w-0 flex-1 text-center sm:text-left">
              ...
              {user.aboutCompany && (
                <p className="mt-2 line-clamp-2 leading-relaxed text-slate-600">
                  {user.aboutCompany}
                </p>
              )}
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-2 sm:justify-start sm:gap-4">
                ...
                {user.companyAddress && (
                  <div className="flex items-center space-x-2 rounded-lg bg-amber-50 px-3 py-1.5 text-sm">
                    ...
                    <span className="max-w-[150px] truncate font-medium text-amber-700">
                      {user.companyAddress}
                    </span>
                  </div>
                )}
            ...
            {/* Action Buttons */}
            <div className="flex shrink-0 flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-3">
              {isFollowing ? (
                <>
                  <button
                    onClick={async () => {
                    ...
                    className="flex items-center justify-center space-x-2 rounded-xl border-2 border-slate-200 bg-white px-6 py-3 text-sm font-medium text-slate-700 transition-all hover:border-slate-300 hover:bg-slate-50 focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 focus:outline-none"
