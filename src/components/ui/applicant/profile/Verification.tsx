...
const ComplianceAndVerification: React.FC = () => {
  ...
  const handleSaveVerification = async () => {
    try {
      ...
      setApplicantData({
        ...applicant,
        governmentIdentificationNumber:
          response?.data?.governmentIdentificationNumber || "",
      });
  ...
  const hasIdNumber =
    verificationData.governmentIdentificationNumber &&
    verificationData.governmentIdentificationNumber.trim() !== "";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Secure verification for account compliance and security
            </p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700">
                  Your identification information is encrypted and securely
                  stored. We use this information for identity verification and
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">
                Enter your national ID, passport number, or driver's license
                number
              </p>
            </div>
          </div>
                ...
                <div className="flex items-center gap-3 rounded-lg border border-purple-200 bg-purple-50 p-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-700">
                      Employers can trust your identity
                    </p>
                  </div>
                </div>
              </div>
        ...
        {!hasIdNumber && !isEditable && (
          <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 py-8 text-center text-gray-500">
            ...
            <p className="text-sm font-medium">
              No verification information provided
            </p>
            <p className="mt-1 text-xs text-gray-400">
              Add your government ID for account verification and enhanced
              security
            </p>
          </div>
        )}
        ...
        {isEditable && (
          <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 p-4">
            ...
            <ul className="space-y-1 text-sm text-amber-700">
              <li>
                • Use your official government-issued identification number
              </li>
              <li>
                • Accepted documents: National ID, Passport, Driver's License
              </li>
              <li>
                • Information is encrypted and used only for verification
                purposes
              </li>
