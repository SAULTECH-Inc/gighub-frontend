...
const ApplicantMessages: FC = () => {
    return (
        <>
            <div className="w-full h-[365px] mx-auto">
                    ...
                    <div>
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="flex flex-col space-y-1">
                                    <h3 className="text-sm md:text-lg font-medium">A.S Abubakar</h3>
                            ...
                            <div className="text-right">
                                <span className="text-xs text-[#56E5A1]">Yesterday</span>
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center space-x-3">
                                <div className="w-[50px] h-[50px] bg-[#D9D9D9] rounded-full"></div>
                                <div className="flex flex-col space-y-1">
                                    <h3 className="text-sm md:text-lg font-medium">Jumaima Nuhu</h3>
                                    <p className="text-xs md:text-sm text-gray-500">
                        ...
                        <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-3">
                                <div className="w-[50px] h-[50px] bg-[#D9D9D9] rounded-full"></div>
                                <div className="flex flex-col space-y-1">
                                    <h3 className="text-sm md:text-lg font-medium">John Abel</h3>
                                    <p className="text-xs md:text-sm text-gray-500">
