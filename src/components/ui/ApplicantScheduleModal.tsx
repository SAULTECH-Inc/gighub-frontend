              ...
              <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <button className="flex w-full items-center justify-center space-x-2 rounded-lg bg-blue-600 px-4 py-2 text-sm text-white transition-colors hover:bg-blue-700">
          ...
          {activeTab === "actions" && (
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4">
                ...
                <button className="flex items-center space-x-2 rounded-xl border border-slate-200 p-3 transition-colors hover:bg-slate-50 sm:space-x-3 sm:p-4">
            ...
            <div className="flex flex-col gap-2 sm:ml-auto sm:flex-row sm:gap-3">
              {userType === UserType.EMPLOYER && (
                <button
                  ...
                  className="flex items-center justify-center space-x-2 rounded-xl border border-red-300 bg-red-50 px-4 py-2 text-sm font-medium text-red-700 transition-colors hover:bg-red-100 sm:px-6 sm:py-3 sm:text-base"
                >
              ...
              <button
                ...
                className="flex items-center justify-center space-x-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-purple-700 hover:to-indigo-700 sm:px-6 sm:py-3 sm:text-base"
              >
