    ...
    >
      ...
      >
        ...
        <div className="mb-6 flex items-center justify-end border-b border-gray-200 pb-4">
          <button
            onClick={close}
            className="rounded-full p-1 text-gray-500 transition-colors duration-200 hover:text-red-600 focus:ring-2 focus:ring-red-300 focus:outline-none"
        ...
        <div className="mb-6 space-y-2 text-center md:text-left">
          <h2
            id="job-modal-title"
            className="text-3xl leading-tight font-extrabold text-gray-900 md:text-4xl"
          >
            {job.title}
          </h2>
        ...
        <div className="mb-8">
          ...
          <div
            ...
            className="prose w-full max-w-none text-base leading-relaxed whitespace-pre-wrap text-gray-700"
