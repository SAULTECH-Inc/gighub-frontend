      ...
      <div className="mb-4 w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
        <div className="flex items-center justify-between border-b border-gray-200 px-3 py-2 dark:border-gray-600">
          ...
          <button
            ...
            className="cursor-pointer rounded-sm p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 sm:ms-auto dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
          >
            <svg
              className="h-4 w-4"
              aria-hidden="true"
