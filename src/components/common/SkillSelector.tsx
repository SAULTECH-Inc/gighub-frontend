  ...
  return (
    <div className="w-full">
      <div className="flex w-full gap-1 sm:gap-3">
        ...
        <input
          type="text"
          className="min-w-[50%] rounded-lg border border-gray-300 px-3 py-2 focus:ring-0 focus:outline-none"
        ...
        <input
          type="number"
          className="min-w-14 rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none sm:w-24"
