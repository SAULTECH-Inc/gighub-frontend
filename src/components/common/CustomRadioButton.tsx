...
const CustomRadioButton: React.FC<CustomRadioButtonProps> = ({
    ...
    return (
        ...
        >
            ...
            <div
                className="flex items-center justify-center transition-all border-2 peer-checked:border-current peer-checked:bg-transparent"
                style={{
                    width: `${size}px`,
                    height: `${size}px`,
                    borderRadius: "50%",
            ...
            {/* Optional Label */}
            {label && <span className="text-gray-800  text-sm sm:text-base">{label}</span>}
        </label>
    );
};
